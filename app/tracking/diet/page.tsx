      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Diet Tracker</h1>
              <p className="text-muted-foreground text-sm">Log your meals and nutrition</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-2xl mx-auto px-4 py-8">
        <Card className="p-8 border-0 bg-gradient-to-br from-green-50 to-emerald-50 mb-6">
          <div className="text-center">
            <div className="text-6xl mb-4">🥗</div>
            <div className="text-5xl font-bold text-green-600 mb-2">1,850</div>
            <p className="text-muted-foreground">Calories today (Goal: 2,000)</p>
          </div>
        </Card>
        <Button className="w-full bg-gradient-to-r from-primary to-accent text-white py-6 text-lg mb-4" onClick={() => router.push('/nutrition')}>
