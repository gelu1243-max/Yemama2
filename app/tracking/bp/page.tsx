        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">Monitor your BP</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-2xl mx-auto px-4 py-8">
        <Card className="p-8 border-0 bg-gradient-to-br from-teal-50 to-green-50 mb-6">
          <div className="text-center">
            <div className="text-6xl mb-4">📊</div>
            <div className="text-5xl font-bold text-teal-600 mb-2">120/80</div>
            <p className="text-muted-foreground">mmHg (Normal)</p>
          </div>
        </Card>
        <Button className="w-full bg-gradient-to-r from-primary to-accent text-white py-6 text-lg mb-4" onClick={() => router.push('/tracking/logs')}>
          <Plus className="w-5 h-5 mr-2" /> Log BP
        </Button>
      </div>
