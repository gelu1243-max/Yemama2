      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Glucose Tracker</h1>
              <p className="text-muted-foreground text-sm">Monitor blood sugar levels</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-2xl mx-auto px-4 py-8">
        <Card className="p-8 border-0 bg-gradient-to-br from-blue-50 to-cyan-50 mb-6">
          <div className="text-center">
            <div className="text-6xl mb-4">💧</div>
            <div className="text-5xl font-bold text-blue-600 mb-2">95</div>
            <p className="text-muted-foreground">mg/dL (Normal range)</p>
          </div>
        </Card>
        <Button className="w-full bg-gradient-to-r from-primary to-accent text-white py-6 text-lg mb-4" onClick={() => router.push('/tracking/logs')}>
          <Plus className="w-5 h-5 mr-2" /> Log Glucose
        </Button>
      </div>
